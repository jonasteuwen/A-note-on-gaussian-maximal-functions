...
\begin{lemma}\label{lem:Time-part-Mehler-time-transform}
  ...
  \begin{equation}
    \label{eq:Time-part-Mehler-time-transform-2}
       0 \leq \frac1t \biggl[\frac{1}{1 + \e^{-t}} - \frac{1}{1 +
         \e^{-\frac{t}{\alpha}}} \biggr] \leq \frac{1}{4} \biggl(1 -
       \frac1\alpha \biggr),
  \end{equation}
  and
  \begin{equation}
    \label{eq:Time-part-Mehler-time-transform-3}
...
\begin{proof}
  ...
  \begin{equation*}
    \frac{\e^{-t}}{1 - \e^{-t}} \leq \frac1\alpha \frac{\e^{-\frac{t}{\alpha}}}{1 -
      \e^{-\frac{t}{\alpha}}} \leq \frac{\e^{-\frac{t}{\alpha}}}{1 - \e^{-t}}
  \end{equation*}
  ...
  \begin{equation*}
    \lim_{t \to 0} \frac1t \biggl[\frac{1}{1 + \e^{-t}} - \frac{1}{1 +
      \e^{-\frac{t}{\alpha}}} \biggr] 
    = \lim_{t \to 0} \biggl[\frac{\e^{-t}}{(1 + \e^{-t})^2} -
    \frac1\alpha \frac{\e^{-\frac{t}{\alpha}}}{(1 +
