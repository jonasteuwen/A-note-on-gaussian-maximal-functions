...
\begin{lemma}\label{lem:Time-part-Mehler-time-transform}
  ...
  \begin{equation}
    ...
    \alpha \frac{\e^{\frac{t^2}{\alpha}}}{\e^{t^2}} \leq \frac{1 -
...
\begin{proof}
  ...
  \leq a$ that
  \begin{equation*}
    \frac{\gamma(B_t(x))}{V_d(t)} \leq d \e^{2 a} \e^{-t^2} \gamma(x)
    \leq d \e^{2 a} \gamma(x).
  \end{equation*}
  \begin{equation}
    \label{eq:Gaussian-ball-Maximal-function-cone-proof-1}
    \frac{\gamma(B_t(x))}{V_d} \leq d \e^{2 a} t^d \gamma(x).
  \end{equation}
  Where we abbreviate $V_d(1)$ with $V_d$.
  Recall
  \begin{equation*}
    V_d \leq \frac1{\sqrt{\pi}} \biggl(\frac{2\pi e}{d} \biggr)^{\frac{d}{2}}.
  \end{equation*}
  To get,
  \begin{equation}
    \label{eq:Gaussian-ball-Maximal-function-cone-proof-2}
    \gamma(B_t(x)) \leq t^d \e^{-(t - |x|)^2} \frac{d}{\sqrt{\pi}} \biggl(\frac{2 e}{d} \biggr)^{\frac{d}{2}}
  \end{equation}
